      ...
      <div className="flex gap-4">
        ...
        <div className="w-24 shrink-0">
          <input 
            ...
            className="w-full px-4 py-3 border-2 border-black dark:border-white rounded-xl font-bold text-center focus:ring-4 focus:ring-yellow-200 outline-none dark:bg-zinc-900 dark:text-white dark:focus:ring-yellow-900"
