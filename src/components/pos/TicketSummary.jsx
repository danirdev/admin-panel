...
const TicketSummary = ({ ticket, total, handleCobrar, lastSale }) => {
  return (
    <Card className="w-full lg:w-96 flex flex-col p-0! overflow-hidden h-full border-4 shadow-xl shrink-0">
      ...
      <div className="bg-gray-50 p-4 border-t-2 border-black space-y-3">
        ...
        {lastSale && (
          <button 
            ...
            className="w-full bg-white text-black border-2 border-black py-2 rounded-lg font-bold hover:bg-gray-100 transition-colors text-sm dashed-border"
          >
